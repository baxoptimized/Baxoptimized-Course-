...
**Format:** Short chunks
**Access:** Only unlocked for new hires after passing the core capstone (Module 15)
**Gate to pass:** Scenario-based quiz (80%)

> ⚠️ **Before granting access:** confirm any IP/non-compete agreement is signed. This hands over real pricing, margins, and the client playbook.
...
| Tier | For | Structure |
|---|---|---|
| **Launch** | "I need a website, I'll handle the rest" | One-off, full handover |
...
|---|---|---|
| Launch ($1,500) | 13-22 hrs | ~$68-115/hr |
| Managed ($149/mo) | ~1.25 hrs/mo after setup | ~$119/hr |
| Growth ($499/mo) | ~8 hrs/mo | ~$62/hr |

> 💡 **Managed is your highest-margin work per hour. Growth pays most in absolute terms but takes real time.** Build a Managed base, layer Growth on top.

**Realistic full solo capacity:** 12 Managed + 4 Growth + 2 Launch/mo ≈ **$6,784/mo (~$81,400/year)** recurring + project work.

---

## 🤝 Client onboarding sequence

**1. Discovery call (20-30 min):** business + ideal customers, current site situation, main goal, service area (suburb-level), top 2-3 competitors, existing assets, timeline.

**2. Proposal:** tier, inclusions, fees, timeline (2-4 wks typical), payment terms, "materials due by" date.

**3. Collect materials:** logo, brand colours, photos, copy, testimonials, contact details, social links, GBP/registrar logins if existing. Chase once after 3 business days.
...
| Week | Tasks |
|---|---|
| 1 | GBP post #1, uptime/performance check, GSC review, start content draft |
| 2 | GBP post #2, finish + publish content, submit URL to GSC, edits |
...
**One-time build, cloned per client:**
1. **lookerstudio.google.com** → new report
2. Data sources: client's **GA4** + **Search Console**
...
4. No cure-rate or guaranteed-outcome claims
5. No unrealistic result expectations

| ✅ Safe | ❌ Unsafe |
|---|---|
| "Experienced physiotherapy team in Wollongong" | "Best physio on the South Coast" |
| "Helping patients move better since 2015" | "We guarantee results" |

> ⚠️ Flag this to every health practitioner client at onboarding, every time. AHPRA fines are real and serious.

---

## 🚫 What's not offered (yet)

| Service | Why not yet |
|---|---|
| Google/Meta Ads | Different skill, needs client spend for margin |
...
> 🚫 Saying yes to everything is how solo operators burn out and ship work that isn't good.
...
## 📍 GBP ongoing management, in practice
...
1. A Launch client's site just went live. The upsell script?
   - a) Wait 6 months, cold-email about Managed
   - b) At handover: "who's keeping it secure, backed up, updated?" ✅
   - c) Never mention Managed unless asked
   - d) Immediate discount on Growth

2. A Managed client asks "how do I get more calls?" Your move?
   - a) Tell them it's not included, end conversation
   - b) Recognise this as the natural Growth opening ✅
   - c) Wait for the next scheduled check-in
...
4. A builder client wants you to run Google Ads too.
   - a) Agree immediately
   - b) "Not something I currently offer, but I can recommend someone" ✅
   - c) Quote a price despite no experience
   - d) Say it's impossible to ever get help
...
6. Effective hourly rate of Managed tier after setup?
   - a) ~$30/hr
   - b) ~$119/hr ✅
   - c) ~$500/hr
   - d) Not measured hourly

7. A Growth client asks why rankings haven't moved after 3 weeks.
   - a) Apologise, offer a refund
   - b) Explain 3-6 month realistic timelines, share progress so far ✅
   - c) Promise it's fixed by next week
   - d) Say rankings never change
...
9. Before granting Operator module access to a new hire?
   - a) Nothing extra needed
   - b) Confirm IP/non-compete is signed first ✅
   - c) Wait exactly one year
   - d) Give access day one, before technical training
